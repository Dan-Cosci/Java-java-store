...
public class Cart extends javax.swing.JPanel {
    ...
    public void loadCart(){
        ...
        for (int i = 0; i < store.cartItems.size(); i++) {
            ItemReciept item = new ItemReciept(store.cartItems.get(i),this);
            this.cartItems.add(item);
            JLabel label = new JLabel(store.cartItems.get(i).getItem());
            label.setFont(new Font("montserrat",0,15));
            jPanel3.add(label);
        }
